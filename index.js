...
app.get('/', (req, res) => {
    fs.readFile('./templates/template.html', 'utf8', (err, content) => {
        ...
        const csp = req.query.cspPolicy?req.query.cspPolicy: "default-src 'self' 'nonce-2726c7f26c'; report-uri /csp-report; img-src 'self' *.imgur.com; script-src 'self' code.jquery.com"
